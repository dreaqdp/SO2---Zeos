...
.globl sys_sem_init_wrapper; .type sys_sem_init_wrapper, @function; .align 0; sys_sem_init_wrapper:
 push %ebp
 mov %esp, %ebp
 #feedback e1c: guardar parametres
 push %ebx
...
.globl sys_sem_wait_wrapper; .type sys_sem_wait_wrapper, @function; .align 0; sys_sem_wait_wrapper:
 push %ebp
 mov %esp, %ebp
 #feedback e1c: guardar parametres
 push %ebx
...
.globl sys_sem_signal_wrapper; .type sys_sem_signal_wrapper, @function; .align 0; sys_sem_signal_wrapper:
 push %ebp
 mov %esp, %ebp
 #feedback e1c: guardar parametres
 push %ebx
...
.globl sys_sem_destroy_wrapper; .type sys_sem_destroy_wrapper, @function; .align 0; sys_sem_destroy_wrapper:
 push %ebp
 mov %esp, %ebp
 #feedback e1c: guardar parametres
 push %ebx
