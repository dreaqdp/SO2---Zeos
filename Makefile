...
SYSOBJ = interrupt.o Kernel.o entry.o sys_call_table.o io.o sched.o sys.o mm.o devices.o utils.o hardware.o list.o circbuff.o

LIBZEOS = -L . -l zeos -l auxjp

#add to USROBJ the object files required to complete the user program
USROBJ = libc.o libjp.a suma.o entry_wrapper.o # libjp.a
...
Kernel.s: Kernel.S $(INCLUDEDIR)/asm.h
	$(CPP) $(ASMFLAGS) -o $@ $<
	
entry_wrapper.s: entry_wrapper.S $(INCLUDEDIR)/asm.h
	$(CPP) $(ASMFLAGS) -o $@ $<
